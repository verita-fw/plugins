About the Muro plugins
==========================

The plugins collection offers users and developers a way to quickly
build additions for Muro that can be optionally installed.  As
...
emulators/qemu-guest-agent -- QEMU Guest Agent for Muro
...
When an Muro release is built, the plugins are automatically
