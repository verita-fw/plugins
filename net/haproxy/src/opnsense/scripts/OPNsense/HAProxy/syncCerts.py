...
def get_args():
    ...
    parser = argparse.ArgumentParser(
        description="""
        Sync ssl certificates into Primary Server Load Balancer memory with certificates read from a configfile. If no frontend filter is
...
""" Sync ssl certs from configfile to Primary Server Load Balancer """
