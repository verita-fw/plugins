...
/usr/local/opnsense/scripts/Muro/HAProxy/exportCerts.php > /dev/null 2>&1
/usr/local/opnsense/scripts/Muro/HAProxy/exportLuaScripts.php > /dev/null 2>&1
/usr/local/opnsense/scripts/Muro/HAProxy/exportErrorFiles.php > /dev/null 2>&1
/usr/local/opnsense/scripts/Muro/HAProxy/exportMapFiles.php > /dev/null 2>&1

# update OCSP data
if [ "${haproxy_ocsp}" == "YES" ]; then
  /usr/local/opnsense/scripts/Muro/HAProxy/updateOcsp.sh > /dev/null 2>&1
fi
